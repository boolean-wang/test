...
class Controller extends Analyse{
	...
	function __construct(){
		$this->_db = new mysqli('localhost','root','321huhuhu','sogou_wechat'); //将连接资源给到 $this->_db
	...
	public function work($id){
		...
		$id=$task['id'];
		// get new data 
		parent::__construct($task['keyword'],$page); //拿到想要进行抓取的关键字 调用父类的 构造方法
		$data=$this->results();
